...
//               <img src="https://source.unsplash.com/random/500x200/?burger" className="d-block w-100" alt="..." />
//             </div>
//             <div className="carousel-item">
//               <img src="https://source.unsplash.com/random/500x200/?momos" className="d-block w-100" alt="..." />
//             </div>
//             <div className="carousel-item">
//               <img src="https://source.unsplash.com/random/500x200/?pizza" className="d-block w-100" alt="..." />
//             </div>
//           </div>
...
//                           <Card foodName={filterItems.name} option={filterItems.options[0]} imgSrc={filterItems.img}></Card>
//                         </div>
//                       )
...
export default function Home() {
  ...
  const [foodItem, setFoodItem] = useState([]);
  const loadData = async () => {
    let response = await fetch("https://tastetracker.onrender.com/api/foodData", {
      method: "POST",
      headers: {
        'Content-Type': 'application/json'
      }
